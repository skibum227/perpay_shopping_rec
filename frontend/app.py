...
# logo_b64 = image_to_base64("perpay_logo.png")
# st.markdown(
#     f"""
#     <div class="header-wrapper">
#         <img src="data:image/png;base64,{logo_b64}" class="header-logo">
#         <div class="header-text">
#             <div class="header-title">LLM-Powered Product Finder</div>
#              </div>
#     </div>
#     """,
#     unsafe_allow_html=True
...
<style>
    ...
    .header-title { font-size: 2rem; font-weight: 700; margin: 0; padding: 0; }
    .header-caption { font-size: 0.9rem; color: #555; margin: 2px 0 0 0; }
</style>
""", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    profitability_w = st.slider("Profitability weighting", 0.0, 1.0, 0.0, 0.05)
    return_rate_w  = st.slider("Return-rate weighting",   0.0, 1.0, 0.0, 0.05)
    alpha = st.slider("Cosine vs Business (alpha)", 0.0, 1.0, 0.70, 0.05)
...
if submitted and user_text.strip():
    ...
    if items:
        ...
        cols = [c for c in [
            ...
            "product_id","name","brand","current_price","product_url"
        ] if c in df.columns]
        st.dataframe(df[cols] if cols else df, use_container_width=True)
